...
main: $(OBJDIR)/queue.o $(OBJDIR)/fifo_algorithm.o $(OBJDIR)/proc.o $(OBJDIR)/display.o
	$(CC)  $^ -o $@

$(OBJDIR)/fifo_algorithm.o:  $(SRCDIR)/fifo_algorithm.c  dataStruct/queue.h
	$(CC) $(CFLAGS) -c $<   -IdataStruct -Idisplay_manger

$(OBJDIR)/queue.o: dataStruct/queue.c dataStruct/queue.h process_config/global_config.h
	$(CC) $(CFLAGS) -c $<  -Iprocess_config
